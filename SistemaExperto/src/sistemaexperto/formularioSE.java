...
public class formularioSE extends javax.swing.JFrame {
    ...
    /**
     * Createa un nuevo formularioSE
     */
    public formularioSE() {
        initComponents();
        setTitle("Sistema Experto de Diagnostico de Enfermedades UMB");
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Universidad Manuela Beltran");
    ...
    private void diabetes(){
      ...
      if((u==0) && (d==0) && (t==0) && (c==0) && (ci==0) && (se==0)){
           String dg = "----------------------------------------------------\n"
                     + "-  Sistema Experto de diagnostico UMB               \n"
